...
import { Building2, Check, X, ChevronLeft } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-8 space-y-8">
                ...
                <div className="bg-white rounded-[32px] shadow-[0_30px_70px_-45px_rgba(15,23,42,0.45)] border border-border/40 p-8">
                    <div className="text-center py-12">
                        ...
                        <h3 className="text-xl font-bold text-slate-800 mb-2">No pending properties</h3>
                        <p className="text-slate-500 max-w-md mx-auto">
                            All property submissions have been reviewed. New submissions will appear here.
                        </p>
                    </div>
                </div>
            </div>
