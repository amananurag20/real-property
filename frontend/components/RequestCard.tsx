...
const RequestCard = ({ 
  ...
  return (
    <article className="bg-white rounded-[28px] p-6 shadow-[0_25px_50px_-30px_rgba(15,23,42,0.4)] border border-border/50 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_35px_70px_-35px_rgba(15,23,42,0.45)] flex flex-col h-full">
      ...
      <Button className="w-full h-10 rounded-xl bg-slate-900 text-white font-semibold hover:bg-slate-800 transition-all flex-shrink-0 mt-4">
        Connect
      </Button>
    </article>
  );
