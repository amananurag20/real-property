...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // We defer to globals.css for theme colors, but we can keep these as fallbacks or utility extensions
        // Primary: Indigo/Blue
        primary: {
          50: '#eef2ff',
          100: '#e0e7ff',
        ...
        // Secondary: mapped to neutral/slate for a cleaner B2B look
        secondary: {
          50: '#f8fafc',
          100: '#f1f5f9',
          200: '#e2e8f0',
      ...
      fontSize: {
        // Ensure typography scale is clean
      ...
      spacing: {
        // 4px base unit system, 8px increments favored
        0.5: '2px',
        1: '4px',
        2: '8px',
        3: '12px',
